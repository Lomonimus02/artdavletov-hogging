    ...
    <div className="min-h-screen bg-white pt-16">
      ...
      <div className="py-8">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-12">
          ...
          <div className="grid grid-cols-2 md:grid-cols-6 gap-4 md:gap-4 text-sm font-black uppercase tracking-wider">
            <div>
              <span className="text-gray-500 block mb-1">{t('project.detail.category')}</span>
              <span className="text-black">{project.category}</span>
            </div>
            <div>
              <span className="text-gray-500 block mb-1">{t('project.detail.type')}</span>
              <span className="text-black">{project.type}</span>
            </div>
            <div>
              <span className="text-gray-500 block mb-1">{t('project.detail.location')}</span>
              <span className="text-black">{translateCity(project.city)}</span>
            </div>
            <div>
              <span className="text-gray-500 block mb-1">{t('project.detail.area')}</span>
              <span className="text-black">{project.area}</span>
            </div>
            <div>
              <span className="text-gray-500 block mb-1">{t('project.detail.year')}</span>
              <span className="text-black">{project.year}</span>
            </div>
            <div>
              <span className="text-gray-500 block mb-1">{t('project.detail.section')}</span>
