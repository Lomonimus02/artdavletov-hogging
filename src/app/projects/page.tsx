      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 border-b border-gray-100 projects-page-header" data-service-id="header">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex items-center justify-center gap-4 mt-8">
            <a
              href="/contacts"
              className="inline-flex items-center justify-center bg-white text-black border-2 border-black px-8 py-3 font-black uppercase tracking-wider text-lg md:text-xl lg:text-2xl hover:bg-black hover:text-white transition-colors duration-500 h-[52px]"
            >
            ...
            <button
              ...
              className="bg-white text-black border-2 border-black px-4 py-3 font-black uppercase tracking-wider hover:bg-black hover:text-white transition-colors duration-500 flex items-center justify-center h-[52px]"
        ...
        <section className={`py-8 px-4 sm:px-6 lg:px-8 bg-gray-50 border-b border-gray-100 mobile-filters-wrapper ${isFilterOpen ? 'filter-open' : ''}`}>
          <div className="max-w-7xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {/* Type Filter */}
              <div>
                <h3 className="text-lg font-black uppercase tracking-wider text-gray-700 mb-4">{t('projects.filter.type.label')}</h3>
              ...
              {/* City Filter */}
              <div>
                <h3 className="text-lg font-black uppercase tracking-wider text-gray-700 mb-4">{t('projects.filter.location.label')}</h3>
