    ...
    <div className="min-h-screen bg-white mobile-no-overflow">
      ...
      <section className="h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8 relative overflow-hidden mobile-hero-container mobile-no-overflow">
        ...
        <div className="hidden md:block absolute bottom-16 left-12 z-10 hero-text-container">
          <h1 className={`text-4xl lg:text-6xl xl:text-8xl font-bold text-white mb-6 tracking-wider uppercase hero-title-three-lines transition-all duration-[2500ms] ${
            heroTextAnimated
              ? 'transform scale-100 opacity-100'
              : 'transform scale-[1.4] opacity-100'
          }`}
          style={{
            lineHeight: '1.1',
            textAlign: 'left',
          ...
          <p className={`text-xl lg:text-2xl xl:text-4xl text-white font-medium leading-relaxed uppercase tracking-wide transition-all duration-[2500ms] ${
            heroTextAnimated
              ? 'transform scale-100 opacity-100'
              : 'transform scale-[1.4] opacity-100'
          }`}
        ...
        <div className={`block md:hidden absolute left-4 z-10 mobile-hero-text-container-animated ${
          heroTextAnimated ? 'hero-text-final' : 'hero-text-initial'
        }`}>
          <h1 className="text-3xl font-bold text-white mb-4 tracking-wider uppercase hero-title-three-lines"
          style={{
            lineHeight: '1.1',
            textAlign: 'left',
            whiteSpace: 'normal',
          ...
          <p className="text-lg text-white font-medium leading-relaxed uppercase tracking-wide"
          style={{
            textAlign: 'left',
            transformOrigin: 'left bottom',
            textShadow: '2px 2px 8px rgba(0, 0, 0, 0.7), 0px 0px 20px rgba(0, 0, 0, 0.5)',
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gray-50 mobile-stats-section">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 gap-16 text-center mobile-stats-grid md:hidden">
            <div>
              <p className="text-2xl font-bold text-black leading-relaxed uppercase tracking-wide mobile-stats-text">
          ...
          {/* Desktop Layout - Horizontal in one line */}
          <div className="hidden md:flex justify-center items-baseline gap-8 lg:gap-12 xl:gap-16 text-center">
            <span className="text-2xl md:text-3xl lg:text-4xl font-bold text-black uppercase tracking-wide whitespace-nowrap">
              {t('home.stats.professionals')}
            </span>
            <span className="text-2xl md:text-3xl lg:text-4xl font-bold text-black uppercase tracking-wide whitespace-nowrap">
              {t('home.stats.specializations')}
          ...
          <div className="space-y-0">
            ...
            >
              ...
              <div className="absolute bottom-4 left-4 md:bottom-6 md:left-6 z-10">
                <h3 className={`text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-white uppercase tracking-wider transition-all duration-[2500ms] ${
            ...
            <section className="py-8 md:py-20 px-4 sm:px-6 lg:px-8 bg-gray-50">
              <div className="max-w-7xl mx-auto">
                <div className="text-center">
                  <p className="text-2xl md:text-3xl lg:text-4xl font-light text-black leading-relaxed uppercase tracking-wide"
              ...
              <div className="absolute bottom-4 left-4 md:bottom-6 md:left-6 z-10">
                <h3 className={`text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-white uppercase tracking-wider transition-all duration-[2500ms] ${
                  servicesTextAnimated.has('interior')
                    ? 'transform scale-100 opacity-100'
                    : 'transform scale-[1.2] sm:scale-[1.5] md:scale-[1.7] opacity-100'
                }`}
                    style={{
                      textShadow: '2px 2px 8px rgba(0, 0, 0, 0.7), 0px 0px 20px rgba(0, 0, 0, 0.5)',
                      transformOrigin: 'left bottom'
