...
const translations = {
  ru: {
    ...
    // Home page
    'home.hero.title': 'Будущее городов начинается с наших чертежей',
    ...
    'about.team.member1.name': 'Артём Давлетов',
    'about.team.member1.position': 'Главный архитектор',
    'about.team.member2.name': 'Анна Петрова',
    'about.team.member2.position': 'Ведущий дизайнер',
    'about.team.member3.name': 'Михаил Сидоров',
    'about.team.member3.position': 'Архитектор',
    'about.team.member4.name': 'Елена Козлова',
    'about.team.member4.position': 'Дизайнер интерьеров',
    'about.team.member5.name': 'Дмитрий Волков',
    'about.team.member5.position': '3D-визуализатор',
    'about.team.member6.name': 'София Морозова',
    'about.team.member6.position': 'Ландшафтный дизайнер',
    'about.team.member7.name': 'Александр Новиков',
    'about.team.member7.position': 'Проектировщик',
    'about.team.member8.name': 'Мария Федорова',
    'about.team.member8.position': 'Менеджер проектов',
    'about.team.member9.name': 'Игорь Лебедев',
    'about.team.member9.position': 'Конструктор',
    'about.team.member10.name': 'Ольга Смирнова',
    'about.team.member10.position': 'Дизайнер',
    ...
    'project.2.title': 'ЧАСТНЫЙ ДОМ В ЖУКОВКЕ, МО',
    'project.2.category': 'Коммерческая недвижимость',
    'project.2.type': 'Эскизный проект',
    'project.2.city': 'Казань',
    'project.2.description': 'Современная архитектура с элементами минимализма.',
    ...
    'project.7.title': 'ДЕТСКИЙ САД В ЕКАТЕРИНБУРГЕ',
    'project.7.category': 'Образование',
    'project.7.type': 'Общественный',
    'project.7.city': 'Екатеринбург',
    'project.7.description': 'Современный детский сад с игровыми зонами и образовательными пространствами.',
    ...
    'project.9.title': 'БУТИК-ОТЕЛЬ В САНКТ-ПЕТЕРБУРГЕ',
    'project.9.category': 'Гостиница',
    'project.9.type': 'Коммерческий',
    'project.9.city': 'Санкт-Петербург',
    'project.9.description': 'Элегантный бутик-отель с уникальным дизайном и высоким уровнем сервиса.',
    ...
    'project.12.title': 'ЧАСТНАЯ БИБЛИОТЕКА В МОСКВЕ',
    'project.12.category': 'Библиотека',
    'project.12.type': 'Жилой',
    'project.12.city': 'Москва',
    'project.12.description': 'Уютная частная библиотека с современным дизайном и комфортными зонами для чтения.',
  ...
  en: {
    ...
    // Home page
    'home.hero.title': 'The future of cities begins with our blueprints',
    ...
    'about.team.member1.name': 'Artem Davletov',
    'about.team.member1.position': 'Chief Architect',
    'about.team.member2.name': 'Anna Petrova',
    'about.team.member2.position': 'Lead Designer',
    'about.team.member3.name': 'Mikhail Sidorov',
    'about.team.member3.position': 'Architect',
    'about.team.member4.name': 'Elena Kozlova',
    'about.team.member4.position': 'Interior Designer',
    'about.team.member5.name': 'Dmitry Volkov',
    'about.team.member5.position': '3D Visualizer',
    'about.team.member6.name': 'Sofia Morozova',
    'about.team.member6.position': 'Landscape Designer',
    'about.team.member7.name': 'Alexander Novikov',
    'about.team.member7.position': 'Project Designer',
    'about.team.member8.name': 'Maria Fedorova',
    'about.team.member8.position': 'Project Manager',
    'about.team.member9.name': 'Igor Lebedev',
    'about.team.member9.position': 'Constructor',
    'about.team.member10.name': 'Olga Smirnova',
    'about.team.member10.position': 'Designer',
  ...
  zh: {
    ...
    'about.team.member1.name': '阿尔捷姆·达夫列托夫',
    'about.team.member1.position': '首席建筑师',
    'about.team.member2.name': '安娜·彼得罗娃',
    'about.team.member2.position': '首席设计师',
    'about.team.member3.name': '米哈伊尔·西多罗夫',
    'about.team.member3.position': '建筑师',
    'about.team.member4.name': '叶莲娜·科兹洛娃',
    'about.team.member4.position': '室内设计师',
    'about.team.member5.name': '德米特里·沃尔科夫',
    'about.team.member5.position': '3D可视化师',
    'about.team.member6.name': '索菲亚·莫罗佐娃',
    'about.team.member6.position': '景观设计师',
    'about.team.member7.name': '亚历山大·诺维科夫',
    'about.team.member7.position': '项目设计师',
    'about.team.member8.name': '玛丽亚·费多罗娃',
    'about.team.member8.position': '项目经理',
    'about.team.member9.name': '伊戈尔·列别杰夫',
    'about.team.member9.position': '构造师',
    'about.team.member10.name': '奥尔加·斯米尔诺娃',
    'about.team.member10.position': '设计师',
