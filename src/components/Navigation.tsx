...
const Navigation = () => {
  ...
  const shouldUseWhiteElements = !isMenuOpen && (isInHeroSection || (pathname === '/' && isDarkBackground) || (pathname !== '/' && isDarkBackground));
        ...
        <div className="w-full px-6 lg:px-12">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center">
              <button
                onClick={toggleMenu}
                className={`inline-flex items-center justify-center p-2 focus:outline-none transition-colors duration-300 z-[110] relative mobile-menu-button ${
              ...
              >
                ...
                <div className="w-6 h-6 flex flex-col justify-center items-center">
                  <span
                    className={`block transition-all duration-300 ease-in-out h-0.5 w-6 rounded-sm mobile-menu-icon ${
                      isMenuOpen
                  ...
                  ></span>
                  <span
                    className={`block transition-all duration-300 ease-in-out h-0.5 w-6 rounded-sm my-0.5 mobile-menu-icon ${
                      isMenuOpen
                        ? 'bg-black opacity-0'
                        : shouldUseWhiteElements
